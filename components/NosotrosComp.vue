<template>
  <div>
    ...
    <p>
      ...
      ISO 9001”, Sistemas de Gestión Ambiental SGA “NTC ISO 14001”, Sistema de
      Gestión en Seguridad y Salud Ocupacional “OSHAS 18001” y Seguridad BASC)
      la cual cuenta con un grupo de profesionales de diversas disciplinas con
      vinculación directa que garantizan el cumplimiento del principio de
    ...
    <p>
      ...
      actividades, disminución de los índices de accidentalidad, mejoramiento de
      la productividad, disminución del ausentismo en los trabajadores a nivel
      laboral, manteniendo una alta solidez y satisfacción en salud de todos los
      trabajadores y de esta forma poder cumplir con cada uno de los requisitos
